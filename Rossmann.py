...
class Rossmann (object):
    def __init__(self):
        self.home_path=''
        self.competition_distance_scaler   = pickle.load( open( 'parametros/competition_distance_scaler.pkl', 'rb') )
        self.competition_time_month_scaler = pickle.load( open( 'parametros/competition_time_month_scaler.pkl', 'rb') )
        self.promo_time_week_scaler        = pickle.load( open( 'parametros/promo_time_week_scaler.pkl', 'rb') )
        self.year_scaler                   = pickle.load( open( 'parametros/year_scaler.pkl', 'rb') )
        self.store_type_scaler             = pickle.load( open( 'parametros/store_type_scaler.pkl', 'rb') )
